...
window.scene.getMeshByName('sec_' + i + '_door2m_' + ii).position.x = startXTemp +  balkXposition[ii];
//DOOR 3
window.scene.getMeshByName('sec_' + i + '_door3m_glass_' + ii).position.x = startXTemp + elementXposition[ii];
window.scene.getMeshByName('sec_' + i + '_door3m_' + ii).position.x = startXTemp +  balkXposition[ii];
//DOOR 4
...
if(window.appSection[i].wall==true)
{
  ...
  window.scene.getMeshByName('sec_' + i + '_wall').position.x= startXTemp + cursorX + 0.01;//+ 0.075;
...
if (window.appSection[i].orientation == true)
{
  startXTemp = startX + (sectionWidth - cursorX) - 0.3;

if (window.appState['rooftype']==0 && window.appState['deepth']>=4500)
  startXTemp = startX + (sectionWidth - cursorX) - 0.3 - 0.1;
...
//  window.scene.getMeshByName('sec_' + i + '_wall').position.z = startXTemp + cursorX + 0.01 ;//+ 0.01;//+ 0.075;
  ...
  window.scene.getMeshByName('sec_' + i + '_wall').position.z = startXTemp + cursorX + 0.01 ;//+ 0.01;//+ 0.075;
  if (window.appSection[i].orientation == true)
  window.scene.getMeshByName('sec_' + i + '_wall').position.z = startX - 0.01 ; //- 0.15;//+ 0.01;//+ 0.075;


  window.scene.getMeshByName('sec_' + i + '_wall').position.x = (x/-2 + 0.01 ) * zMultiplicator;
  window.scene.getMeshByName('sec_' + i + '_wall').scaling.x = ((window.appState['deepth'] - 150 - 100 -10 )/1000 - cursorX) /2.775 - 0.01;
}
...
if(window.appSection[i].wall==true)
{
  ...
  if (window.appSection[i].orientation == true)
  window.scene.getMeshByName('sec_' + i + '_wall').position.z = startX ;//+ 0.01;//+ 0.075;
...
//  window.scene.getMeshByName('sec_' + i + '_wall').position.z = startXTemp + cursorX + 0.01 ;//+ 0.01;//+ 0.075;
  ...
  window.scene.getMeshByName('sec_' + i + '_wall').position.x = (x/-2 + 0.01 ) * zMultiplicator;
  window.scene.getMeshByName('sec_' + i + '_wall').scaling.x = ((window.appState['deepth'] - 1000 - 150 - 100 )/1000 - cursorX) /2.775 - 0.01;
}
...
if (window.appSection[i].orientation==true) window.scene.getMeshByName('sec_' + i + '_balk_0').setEnabled(true);
