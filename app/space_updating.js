...
if (i==0 || i==1)
{
console.log(window.appSection[i]);
...
//if(i==window.appState['uiSpaceID'] && window.appState['uiSpaceUIEnabled']==true)
window.scene.getMeshByName('sec_' + i + '_plane').setEnabled(true);


//if (window.appSection[i].place1==1)window.scene.getMeshByName('sec_' + i + '_zhaluzi_1').setEnabled(true);
//if (window.appSection[i].place2==1)window.scene.getMeshByName('sec_' + i + '_zhaluzi_2').setEnabled(true);
//if (window.appSection[i].place3==1)window.scene.getMeshByName('sec_' + i + '_zhaluzi_3').setEnabled(true);
...
if(
(window.appState['sectionWidth']/1000 > cursorX + 1 && ( window.appSection[i].place[ii]==1 || window.appSection[i].place[ii]==2))
||
(window.appState['sectionWidth']/1000 > cursorX + 2 && window.appSection[i].place[ii]==3)
)
...
window.scene.getMeshByName('sec_' + i + '_plane').position.x = startX + window.appState['sectionWidth']/2000;
window.scene.getMeshByName('sec_' + i + '_plane').position.z = z/-2 - 0.01;
