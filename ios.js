...
window.scene.getMaterialByName('RoofTileMaterial').clone('RoofTrimMaterial');

roofBorder1.material=window.scene.getMaterialByName('RoofTrimMaterial');
roofBorder2.material=window.scene.getMaterialByName('RoofTrimMaterial');
roofBorder3.material=window.scene.getMaterialByName('RoofTrimMaterial');
roofBorder4.material=window.scene.getMaterialByName('RoofTrimMaterial');
...
roofMaterial4.roughness = 0.7;
roofMaterial5.roughness = 0.7;


roofMaterial1.metallic = 0.1;
roofMaterial2.metallic = 0.1;
roofMaterial3.metallic = 0.1;
roofMaterial4.metallic = 0.1;
roofMaterial5.metallic = 0.1;
...
//document.getElementById('canvas2d').style.left='0px';
...
document.getElementById('builderBlockText6').innerHTML = '5. CALCULATE PRICE AND ORDER';
...
//window.appSection[15].wall=true;
...
if(
(window.appSection[i].place[ii]==1   && (window.appSection[i].place[ii-1]==2 || window.appSection[i].place[ii-1]==3 || window.appSection[i].place[ii-1]==4))
||
(window.appSection[i].place[ii-1]==1 && (window.appSection[i].place[ii]==2  || window.appSection[i].place[ii]==3 || window.appSection[i].place[ii]==4))
||
...
if (sectionFull == 1) {console.log('full');}
...
drawDoor(centerWall + shift, center + z/2, Math.PI/-2, ctx, true);
}
...
let centerWall= (center - x/2  + 1 ) + (window.appState['house1width']/20)/2 + 3.5;
drawDoor(centerWall + shift, center + z/2, Math.PI/-2, ctx, false);
}
...
let centerWall= (center - x/2  + 1 ) + (window.appState['house1width']/20)/2 + 3.5;
drawDoor(centerWall - shift, center - z/2 +1, Math.PI/2, ctx, true);
}
...
let centerWall= (center - x/2  + 1 ) + (window.appState['house1width']/20)/2 + 3.5;
drawDoor(centerWall - shift, center - z/2 +1, Math.PI/2, ctx, false);
}
...
drawDoor(center - x/2  + 1, center - shift, Math.PI, ctx, true);
}
...
let centerWall= (center - x/2  + 1 ) + (window.appState['house1width']/20)/2;
drawDoor(center - x/2  + 1, center - shift, Math.PI, ctx, false);
}
...
let centerWall= (center - x/2  + 1 ) + (window.appState['house1width']/20)/2;
drawDoor(center - x/2  + 1  + (window.appState['house1width']/20)  + 5.5, center - shift, Math.PI * 2, ctx, true);
}
...
let centerWall= (center - x/2  + 1 ) + (window.appState['house1width']/20)/2;
drawDoor(center - x/2  + 1  + (window.appState['house1width']/20) + 5.5, center - shift, Math.PI * 2 , ctx, false);
}
...
drawDoor(center + x/2 -(window.appState['house2width']/20) -7, center - shift, Math.PI, ctx, true);
}
...
let centerWall= (center + x/2  + 1 ) - (window.appState['house2width']/20)/2;
drawDoor(center + x/2 -(window.appState['house2width']/20) -7, center - shift, Math.PI, ctx, false);
}
...
let centerWall= (center - x/2  + 1 ) + (window.appState['house2width']/20)/2;
drawDoor(center + x/2    , center - shift, Math.PI * 2, ctx, true);
}
...
let centerWall = (center + x/2  + 1 ) - (window.appState['house2width']/20)/2;
drawDoor(center + x/2   , center - shift, Math.PI * 2 , ctx, false);
}
...
function drawDoor(x, y, angle1, ctx, left)
{
ctx.closePath();
ctx.beginPath();
ctx.lineWidth = 3;
...
totalhorisontalBeam = totalSection * 2;
//adding sides
...
item_vertical_beam = (totalSection + 1) * 2;
...
if (window.appState['rooftype']==0 && window.appState['width']>=4500) totalhorisontalBeam = totalhorisontalBeam + 1;
...
console.log("liggersPerimm: " + liggersPerimm);
document.getElementById('liggersmm').innerHTML =  liggersPerimm;
...
if (window.appState['rooftype']==1)
{
boidelMm = boidelMm + (window.appState['width']/1000);
boidelMm = boidelMm + (window.appState['width']/1000);
boidelMm = boidelMm + (window.appState['width']/1000); //lastline
boidelMm = boidelMm + (window.appState['deepth']/1000 - 1);
boidelMm = boidelMm + (window.appState['deepth']/1000 - 1);
}
...
boidelMm = boidelMm + (window.appState['width']/1000);
boidelMm = boidelMm + (window.appState['width']/1000);
boidelMm = boidelMm + (window.appState['deepth']/1000);
boidelMm = boidelMm + (window.appState['deepth']/1000);
}
...
document.getElementById('boimm').innerHTML =  boidelMm;
...
if (window.appState['rooftype']==0)
{
alumTrimMmNew = alumTrimMmNew + (window.appState['width']  + window.appState['overhangLeft']  + window.appState['overhangRight']) / 1000;
alumTrimMmNew = alumTrimMmNew + (window.appState['width']  + window.appState['overhangLeft']  + window.appState['overhangRight']) / 1000;
alumTrimMmNew = alumTrimMmNew + (window.appState['deepth'] + window.appState['overhangFront'] + window.appState['overhangBack']) / 1000;
alumTrimMmNew = alumTrimMmNew + (window.appState['deepth'] + window.appState['overhangFront'] + window.appState['overhangBack']) / 1000;
...
document.getElementById('boimm').innerHTML =  alumTrimMmNew;
...
if (window.appState['rooftype']==1)
{
frameMm = frameMm + (window.appState['width']/1000);
frameMm = frameMm + 1;
frameMm = frameMm + 1;
}
...
if (window.appState['rooftype']==1)
{
frameMm = frameMm + (window.appState['deepth']/1000 - 1);
frameMm = frameMm + (window.appState['deepth']/1000);
frameMm = frameMm + (window.appState['house1width']/1000);
frameMm = frameMm + (window.appState['house1width']/1000);
}
if (window.appState['rooftype']==0)
{
...
frameMm = frameMm + (window.appState['deepth']/1000 -1);
frameMm = frameMm + (window.appState['deepth']/1000);
frameMm = frameMm + (window.appState['house2width']/1000);
frameMm = frameMm + (window.appState['house2width']/1000);
}
if (window.appState['rooftype']==0)
{
...
for(let i=0;i<=17;i++)
{
if(window.scene.getMeshByName('sec_' + i + '_frame').isEnabled() == true)
{
...
let rabbat = (frameMm + sectionFrameM + sectionFrameInnerM) * 12 ;
...
document.getElementById('rabat_mm').innerHTML =  rabbat;
...
//getElements
document.getElementById('rabat').innerHTML =  totalWall * 12;
document.getElementById('item_ringbalk').innerHTML =  totalhorisontalBeam;
document.getElementById('item_total_bo').innerHTML =  item_total_bo;
document.getElementById('item_alum_total').innerHTML =  item_total_bo;
...
item_vertical_beam = item_vertical_beam + 2;
item_vertical_beam_fundament = item_vertical_beam_fundament + 2;
}
...
if (window.appState['rooftype']==1)
{
document.getElementById('squarem').innerHTML = Math.round((((window.appState['deepth']/1000) * (window.appState['width']/1000))*100)/100) ;
...
let price = 0;
price = price + (totalSection * 58);
price = price + (item_window * 80);
price = price + (item_window * 80);
price = price + (item_door_left * 180);
price = price + (item_door_right * 180);
price = price + (item_door_double * 280);


price = price + (item_shutter * 58);
price = price + (item_window1m * 80);
price = price + (item_window2m * 160);
price = price + (item_door2m * 200);
price = price + (item_door3m * 300);
price = price + (item_door4m * 400);
